  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Meet the dedicated veterinarians at Vizag Animal Hospital in Visakhapatnam — Dr. K. Mounika and Dr. B. Santosh Kumar. Experienced, compassionate, and ready to care for your pets."
        />
      </Helmet>
